...
namespace Toolset.Serialization
{
  public abstract class NodeModel
  {
    ...
    public virtual string SerializationText => Change.To<string>(SerializationValue);

    public bool IsDocument { get { return this is DocumentModel; } }
    ...
    public override string ToString() => Change.To<string>(SerializationValue);
