...
namespace Paper.Browser.Windows.Lib
{
    ...
    private ActionForm CreateForm(Entity entity, EntityAction action)
    {
      ...
      foreach (var field in action.Fields)
      {
        ...
        else
        {
          ...
          var typeName = $"Paper.Browser.Windows.Gui.Widgets.{prefix}FieldWidget";
